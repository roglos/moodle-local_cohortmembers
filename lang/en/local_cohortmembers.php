...
/**
 * Strings for component 'local_cohortmembers', language 'en'.
 *
...
$string['pluginname'] = 'cohortmembers';
$string['pluginname_desc'] = 'This local plugin adds users to the relevant cohorts they are part of.<br><strong>NOTE: </strong>Currently this plugin does not use an external database connection - these settings are in place for planned future developments.';
